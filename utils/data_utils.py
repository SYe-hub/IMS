...
from .dataset import CUB, CUB2, CarsDataset, NABirds, dogs, INat2017, Duorou, Flower, AirCraft
...
def get_loader(args):
    ...
    if args.dataset == 'CUB_200_2011':
        ...
        test_transform = transforms.Compose([transforms.Resize((600, 600), Image.BILINEAR),
                                             ...
                                             transforms.ToTensor(),
                                             transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])])
        trainset = Duorou(root=args.data_root, is_train=True, transform=train_transform)
        testset = Duorou(root=args.data_root, is_train=False, transform=test_transform)
        ...
        test_transform = transforms.Compose([transforms.Resize((600, 600), Image.BILINEAR),
                                             ...
                                             transforms.ToTensor(),
                                             transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])])
        trainset = Flower(root=args.data_root, transform=train_transform)
        testset = Flower(root=args.data_root, transform=test_transform, is_train=False)
        ...
        test_transform = transforms.Compose([transforms.Resize((600, 600)),
                                             ...
                                             transforms.ToTensor(),
                                             transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])])
        trainset = AirCraft(root=args.data_root, transform=train_transform, train=True)
        testset = AirCraft(root=args.data_root, transform=test_transform, train=False)
